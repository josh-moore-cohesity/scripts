...
## **Parameters**
* -un (Helios SSO usernames.  Use multiple for multiple users.  IE -un user1 -un user2)
...
## **Examples**
   ...
   ### Add multiple clusters to multiple user's access
    .\update_helios_sso_user.py -un user1@domain.com -un user2@domain.com -c cluster1 cluster2 -a add
